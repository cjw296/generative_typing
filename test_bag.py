...
def test_typing_examples() -> None:
    ...
    stdout = '\n'.join((
        'typing_examples.py:5: error: Argument 1 to "Bag" has incompatible type "float"; expected "int | Callable[[], int]"  [arg-type]',
        'typing_examples.py:6: error: Incompatible types in assignment (expression has type "Bag[float]", variable has type "Bag[int]")  [assignment]',
        'typing_examples.py:24: error: Incompatible types in assignment (expression has type "int", variable has type "str")  [assignment]',
        'typing_examples.py:25: error: Incompatible types in assignment (expression has type "str", variable has type "int")  [assignment]',
